...
#predefined size for window (pygame surface)
...
#border placed in the middle
BORDER = pygame.Rect(WIDTH//2 - 5, 0, 10, HEIGHT)

HEALTH_FONT = pygame.font.SysFont('arial', 48)
...
#how many frames occur in one second
FPS = 60

#velocity of spaeship
VEL = 5

BULLET_VEL = 7
MAX_BULLETS = 5

#spaceship image sizes
...
def main():
    #red is on the right, yellow is on the left
